...
document.addEventListener("click", (e) => {
  ...
  const formNewsPaper = document.querySelector(
    ".container-header-form-newspaper"
  );
  const formAudiovisualResource = document.querySelector(
    ".container-header-form-audiovisual-resource"
  );
  ...
  const btnGenerateAudioVisualResource = document.getElementById(
    "btn-audiovisual-resource"
  );
